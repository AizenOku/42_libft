...
#    Updated: 2018/10/23 16:56:41 by ihuang           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c \
	...
	ft_strrev.c ft_lstrev.c ft_digits.c ft_wordcount.c ft_itoa_base.c \
	gnl.c ft_tabdel.c
...
OBJS = ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o ft_memchr.o \
	...
	ft_strrev.o ft_lstrev.o ft_digits.o ft_wordcount.o ft_itoa_base.o \
	gnl.o ft_tabdel.o
